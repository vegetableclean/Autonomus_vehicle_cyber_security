...
class QArmMini():
    def __init__(self,
        ...
        try:
            ...
            if self.card.is_valid():
                ...
                pGain = [10, 10, 10, 10, 20] #  Proportional Gain (0 to 127  or -1 for default)
                iGain = [-1, 0.036, 0.036, -1, -1] # Integral Gain (0 to 0.24  or -1 for default)
                dGain = [300, 0, 0, 0, 0] # Derivative Gain (0 to 1023  or -1 for default)
                velocityGain = [-1, -1, -1, -1, -1] # Velocity FF Gain (0 to 4095  or -1 for default)
                accelerationGain = [-1, -1, -1, -1, -1] # Acceleration FF Gain (0 to 4095  or -1 for default)
                ...
                # initiate positions on 0s
                self.writeJointPositions()
                ...
                if self._readMode:
                    ...
                    # its for hardware or virtual device
                    if self._hardware:
    ...
    def writeGripperPosition(self, gripper = 0):
        ...
        gripper = gripper * 1.5 - 0.85

        thetaBias = [0]
        actuatorBias = [np.pi/2]
    ...
    def read_outputs(self):
        ...
        try:
            ...
            self.gripperPositionMeasured = (self.gripperPositionMeasured + 0.85) / 1.5
